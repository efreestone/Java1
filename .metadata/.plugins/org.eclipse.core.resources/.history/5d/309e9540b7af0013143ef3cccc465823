...
//	static String testURL = MainActivity.testURL; //"http://api.wunderground.com/api/8204b5c9bf753afb/conditions/q/CO/Loveland.json";
	...
	public static class getData extends AsyncTask<String, Void, String>{
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				URL url = new URL(MainActivity.testURL);
