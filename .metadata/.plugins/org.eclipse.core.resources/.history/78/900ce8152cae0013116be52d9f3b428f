...
public enum CitiesEnum {
	Loveland("Loveland", "CO", 31.6f, -0.2f), LosAngeles("Los Angeles", "CA",
			68.8f, 20.4f), NewYork("New York", "NY", 59.5f, 15.2f), Chicago(
			"Chicago", "IL", 38.3f, 3.5f), Orlando("Orlando", "FL", 71.7f,
			22.0f);
	...
	private CitiesEnum(String cityName, String stateName, Float fahrenheitTemp,
			Float celsiusTemp) {
